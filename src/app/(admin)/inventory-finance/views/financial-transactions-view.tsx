  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
          <button
            ...
            className="w-full sm:w-auto border border-indigo-600 text-indigo-600 px-4 py-2 rounded-lg font-medium hover:bg-indigo-50 transition-colors flex items-center justify-center gap-2"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
          {[
            ...
            },
            {
              ...
              colour: summary.net_profit >= 0 ? 'green' : 'red',
            },
          ].map((card) => (
            <div
              key={card.label}
            ...
            >
              ...
              <p
                className={`text-lg sm:text-xl font-semibold ${card.colour === 'green' ? 'text-green-600' : 'text-red-600'}`}
              >
                {card.value}
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            {transactionTypes.map((t) => (
              <SelectItem key={t.id} value={t.secondary_value || t.value}>
                {t.value}
              </SelectItem>
            ))}
          </ValidationSelect>
              ...
              <div key={tx.id} className="px-4 sm:px-6 py-4 hover:bg-gray-50">
                <div className="flex items-center justify-between">
                  <div className="flex-1 min-w-0 flex items-center gap-3">
                    <div
                      className={`w-2 h-2 rounded-full ${tx.transaction_type === 'income' ? 'bg-green-500' : 'bg-red-500'}`}
                    />
                    <div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-right">
                      <p
                        className={`text-sm font-medium ${tx.transaction_type === 'income' ? 'text-green-600' : 'text-red-600'}`}
                      >
      ...
      <ReceiptScanner
        ...
        isClosing={isScannerModalClosing}
